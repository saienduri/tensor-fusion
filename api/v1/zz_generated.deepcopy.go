...
func (in *AllocatedPartition) DeepCopyInto(out *AllocatedPartition) {
	*out = *in
	...
	if in.AllocatedSlotStart != nil {
		in, out := &in.AllocatedSlotStart, &out.AllocatedSlotStart
		*out = new(uint32)
		**out = **in
	}
	if in.AllocatedSlotEnd != nil {
		in, out := &in.AllocatedSlotEnd, &out.AllocatedSlotEnd
		*out = new(uint32)
		**out = **in
	}
	if in.IsolationGroupID != nil {
		in, out := &in.IsolationGroupID, &out.IsolationGroupID
		*out = new(uint32)
		**out = **in
	}
}
...
func (in *ClientConfig) DeepCopyInto(out *ClientConfig) {
	*out = *in
	if in.ProviderImage != nil {
		in, out := &in.ProviderImage, &out.ProviderImage
...
func (in *ElasticRateLimitParameters) DeepCopy() *ElasticRateLimitParameters {
	...
	out := new(ElasticRateLimitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExternalClientSpec) DeepCopyInto(out *ExternalClientSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExternalClientSpec.
func (in *ExternalClientSpec) DeepCopy() *ExternalClientSpec {
	if in == nil {
		return nil
	}
	out := new(ExternalClientSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *GPUNodeStatus) DeepCopyInto(out *GPUNodeStatus) {
	*out = *in
	...
	if in.AllocatedPods != nil {
		in, out := &in.AllocatedPods, &out.AllocatedPods
		*out = make(map[string][]*PodGPUInfo, len(*in))
		for key, val := range *in {
			var outVal []*PodGPUInfo
			if val == nil {
				(*out)[key] = nil
			} else {
				inVal := (*in)[key]
				in, out := &inVal, &outVal
				*out = make([]*PodGPUInfo, len(*in))
				for i := range *in {
					if (*in)[i] != nil {
						in, out := &(*in)[i], &(*out)[i]
						*out = new(PodGPUInfo)
...
func (in *GPUPoolSpec) DeepCopyInto(out *GPUPoolSpec) {
	*out = *in
	if in.DefaultUsingLocalGPU != nil {
		in, out := &in.DefaultUsingLocalGPU, &out.DefaultUsingLocalGPU
		*out = new(bool)
		**out = **in
	}
...
func (in *HypervisorScheduling) DeepCopyInto(out *HypervisorScheduling) {
	*out = *in
	...
	out.ElasticRateLimitParameters = in.ElasticRateLimitParameters
	out.MultiProcessQueuingParameters = in.MultiProcessQueuingParameters
}
...
func (in *MultiProcessQueuingParameters) DeepCopy() *MultiProcessQueuingParameters {
	...
	out := new(MultiProcessQueuingParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NodeManagerConfig) DeepCopyInto(out *NodeManagerConfig) {
	*out = *in
	...
	if in.MultiVendorNodeSelector != nil {
		in, out := &in.MultiVendorNodeSelector, &out.MultiVendorNodeSelector
		*out = make(map[string]*corev1.NodeSelector, len(*in))
		for key, val := range *in {
			var outVal *corev1.NodeSelector
			if val == nil {
				(*out)[key] = nil
			} else {
				inVal := (*in)[key]
...
func (in *TensorFusionConnectionSpec) DeepCopyInto(out *TensorFusionConnectionSpec) {
	*out = *in
	if in.ExternalClient != nil {
		in, out := &in.ExternalClient, &out.ExternalClient
		*out = new(ExternalClientSpec)
		**out = **in
	}
}
